...
def seed_master_data():
    ...
    try:
        ...
        # 2. Suppliers
        suppliers_data = [
            {"id": "SUP-01", "name": "Apex Poultry Farms", "phone": "+91 98450 11223", "address": "Hosur Road, Bengaluru, Karnataka", "gst_no": "29ABCDE1234F1Z5", "balance": 0.00, "active": True},
            {"id": "SUP-02", "name": "Harvest Frozen Foods", "phone": "+91 98451 22334", "address": "Whitefield Industrial Area, Bengaluru", "gst_no": "29BCDEF2345G1Z6", "balance": 0.00, "active": True},
            {"id": "SUP-03", "name": "Beverage Hub", "phone": "+91 98452 33445", "address": "Peenya 2nd Stage, Bengaluru", "gst_no": "29CDEFG3456H1Z7", "balance": 0.00, "active": True},
        ]
        ...
        inventory_data = [
            {"id": "ING-LEG", "name": "Frozen Chicken Legs", "category": "Poultry", "purchase_unit": "PACKET", "base_unit": "PIECE", "conversion_qty": 10.0, "current_qty": 50.0, "min_limit": 10.0, "avg_cost": 35.00, "supplier_id": "SUP-01", "status": "IN_STOCK"},
            {"id": "ING-WINGS", "name": "Frozen Chicken Wings", "category": "Poultry", "purchase_unit": "PACKET", "base_unit": "PIECE", "conversion_qty": 20.0, "current_qty": 100.0, "min_limit": 15.0, "avg_cost": 22.50, "supplier_id": "SUP-01", "status": "IN_STOCK"},
            {"id": "ING-CHKFRIES", "name": "Frozen Chicken Fries", "category": "Poultry", "purchase_unit": "PACKET", "base_unit": "PIECE", "conversion_qty": 30.0, "current_qty": 150.0, "min_limit": 20.0, "avg_cost": 15.00, "supplier_id": "SUP-01", "status": "IN_STOCK"},
            {"id": "ING-POPCORN", "name": "Frozen Chicken Popcorn", "category": "Poultry", "purchase_unit": "PACKET", "base_unit": "GRAM", "conversion_qty": 1000.0, "current_qty": 5000.0, "min_limit": 800.0, "avg_cost": 0.35, "supplier_id": "SUP-01", "status": "IN_STOCK"},
        ...
        categories_data = [
            ...
            {"id": "cat-cold-drinks", "name": "COLD DRINKS", "icon": "fa-bottle-water", "image_url": "https://images.unsplash.com/photo-1548839140-29a749e1bc4e?auto=format&fit=crop&w=600&q=80", "display_order": 11, "active": True},
        ]
        ...
        products_data = [
            ...
            # Steamed Momos
            {"id": "MOM-01", "category_id": "cat-momos", "name": "Veg Steamed Momos (6 pcs)", "price": 99.00, "selling_unit": "portion", "description": "6 tender steamed momos filled with seasoned minced vegetables.", "image_url": "https://images.unsplash.com/photo-1625220194771-7ebdea0b70b9?auto=format&fit=crop&w=600&q=80", "available": True, "active": True},
            {"id": "MOM-02", "category_id": "cat-momos", "name": "Paneer Steamed Momos (6 pcs)", "price": 119.00, "selling_unit": "portion", "description": "6 tender steamed momos filled with spiced cottage cheese.", "image_url": "https://images.unsplash.com/photo-1625220194771-7ebdea0b70b9?auto=format&fit=crop&w=600&q=80", "available": True, "active": True},
            {"id": "MOM-03", "category_id": "cat-momos", "name": "Chicken Steamed Momos (6 pcs)", "price": 129.00, "selling_unit": "portion", "description": "6 juicy steamed momos filled with seasoned minced chicken.", "image_url": "https://images.unsplash.com/photo-1625220194771-7ebdea0b70b9?auto=format&fit=crop&w=600&q=80", "available": True, "active": True, "inventory_product_id": "ING-MOMOS", "deduction_qty": 6.0},
            {"id": "MOM-04", "category_id": "cat-momos", "name": "Chicken Cheese Steamed Momos (6 pcs)", "price": 149.00, "selling_unit": "portion", "description": "6 steamed momos loaded with minced chicken and melted cheese.", "image_url": "https://images.unsplash.com/photo-1625220194771-7ebdea0b70b9?auto=format&fit=crop&w=600&q=80", "available": True, "active": True, "inventory_product_id": "ING-MOMOS", "deduction_qty": 6.0},
            {"id": "MOM-05", "category_id": "cat-momos", "name": "Chicken BBQ Steamed Momos (6 pcs)", "price": 149.00, "selling_unit": "portion", "description": "6 chicken steamed momos tossed in smoky BBQ sauce.", "image_url": "https://images.unsplash.com/photo-1625220194771-7ebdea0b70b9?auto=format&fit=crop&w=600&q=80", "available": True, "active": True, "inventory_product_id": "ING-MOMOS", "deduction_qty": 6.0},

            # Shawarma
            {"id": "SHW-01", "category_id": "cat-shawarma", "name": "Regular Shawarma (Roll)", "price": 99.00, "selling_unit": "roll", "description": "Authentic spiced chicken wrapped in soft kuboos with garlic toum.", "image_url": "https://images.unsplash.com/photo-1561651823-34feb02250e4?auto=format&fit=crop&w=600&q=80", "available": True, "active": True, "inventory_product_id": "ING-SHAWARMA", "deduction_qty": 1.0},
            {"id": "SHW-02", "category_id": "cat-shawarma", "name": "Regular Shawarma (Plate)", "price": 139.00, "selling_unit": "plate", "description": "Open plate of spiced chicken served with kuboos, salad, and garlic sauce.", "image_url": "https://images.unsplash.com/photo-1561651823-34feb02250e4?auto=format&fit=crop&w=600&q=80", "available": True, "active": True, "inventory_product_id": "ING-SHAWARMA", "deduction_qty": 1.0},
            {"id": "SHW-03", "category_id": "cat-shawarma", "name": "Mexican Shawarma (Roll)", "price": 119.00, "selling_unit": "roll", "description": "Zesty Mexican seasoned chicken with spicy jalapeño sauce in kuboos.", "image_url": "https://images.unsplash.com/photo-1561651823-34feb02250e4?auto=format&fit=crop&w=600&q=80", "available": True, "active": True, "inventory_product_id": "ING-SHAWARMA", "deduction_qty": 1.0},
            {"id": "SHW-04", "category_id": "cat-shawarma", "name": "Mexican Shawarma (Plate)", "price": 159.00, "selling_unit": "plate", "description": "Plated Mexican spiced chicken with salsa and warm pita bread.", "image_url": "https://images.unsplash.com/photo-1561651823-34feb02250e4?auto=format&fit=crop&w=600&q=80", "available": True, "active": True, "inventory_product_id": "ING-SHAWARMA", "deduction_qty": 1.0},
            {"id": "SHW-05", "category_id": "cat-shawarma", "name": "Sweet Chilli Shawarma (Roll)", "price": 119.00, "selling_unit": "roll", "description": "Tender chicken tossed in sweet chilli glaze wrapped in flatbread.", "image_url": "https://images.unsplash.com/photo-1561651823-34feb02250e4?auto=format&fit=crop&w=600&q=80", "available": True, "active": True, "inventory_product_id": "ING-SHAWARMA", "deduction_qty": 1.0},
            {"id": "SHW-06", "category_id": "cat-shawarma", "name": "Sweet Chilli Shawarma (Plate)", "price": 159.00, "selling_unit": "plate", "description": "Sweet chilli glazed chicken shawarma platter with dips.", "image_url": "https://images.unsplash.com/photo-1561651823-34feb02250e4?auto=format&fit=crop&w=600&q=80", "available": True, "active": True, "inventory_product_id": "ING-SHAWARMA", "deduction_qty": 1.0},
            {"id": "SHW-07", "category_id": "cat-shawarma", "name": "BBQ Shawarma (Roll)", "price": 119.00, "selling_unit": "roll", "description": "Smoky BBQ chicken wrapped with onion crunch and creamy garlic mayo.", "image_url": "https://images.unsplash.com/photo-1561651823-34feb02250e4?auto=format&fit=crop&w=600&q=80", "available": True, "active": True, "inventory_product_id": "ING-SHAWARMA", "deduction_qty": 1.0},
            {"id": "SHW-08", "category_id": "cat-shawarma", "name": "BBQ Shawarma (Plate)", "price": 159.00, "selling_unit": "plate", "description": "Smoky barbecue chicken platter served with fresh salad and bread.", "image_url": "https://images.unsplash.com/photo-1561651823-34feb02250e4?auto=format&fit=crop&w=600&q=80", "available": True, "active": True, "inventory_product_id": "ING-SHAWARMA", "deduction_qty": 1.0},
            {"id": "SHW-09", "category_id": "cat-shawarma", "name": "Peri-Peri Shawarma (Roll)", "price": 119.00, "selling_unit": "roll", "description": "Fiery African bird's eye peri-peri spiced chicken roll.", "image_url": "https://images.unsplash.com/photo-1561651823-34feb02250e4?auto=format&fit=crop&w=600&q=80", "available": True, "active": True, "inventory_product_id": "ING-SHAWARMA", "deduction_qty": 1.0},
            {"id": "SHW-10", "category_id": "cat-shawarma", "name": "Peri-Peri Shawarma (Plate)", "price": 159.00, "selling_unit": "plate", "description": "Spicy peri-peri chicken served on an open platter with sauces.", "image_url": "https://images.unsplash.com/photo-1561651823-34feb02250e4?auto=format&fit=crop&w=600&q=80", "available": True, "active": True, "inventory_product_id": "ING-SHAWARMA", "deduction_qty": 1.0},

            # Shawarma & Mojito Combos
            {"id": "SMC-01", "category_id": "cat-shawarma-mojitos", "name": "Roll + Mojito (Lemon) - Roll", "price": 159.00, "selling_unit": "combo", "description": "1 Regular Shawarma Roll + 1 Chilled Lemon Mint Mojito.", "image_url": "https://images.unsplash.com/photo-1551024709-8f23befc6f87?auto=format&fit=crop&w=600&q=80", "available": True, "active": True, "inventory_product_id": "ING-SHAWARMA", "deduction_qty": 1.0},
            {"id": "SMC-02", "category_id": "cat-shawarma-mojitos", "name": "Roll + Mojito (Lemon) - Plate", "price": 199.00, "selling_unit": "combo", "description": "1 Shawarma Plate + 1 Chilled Lemon Mint Mojito.", "image_url": "https://images.unsplash.com/photo-1551024709-8f23befc6f87?auto=format&fit=crop&w=600&q=80", "available": True, "active": True, "inventory_product_id": "ING-SHAWARMA", "deduction_qty": 1.0},
            {"id": "SMC-03", "category_id": "cat-shawarma-mojitos", "name": "Roll + Mojito (Blue Lagoon) - Roll", "price": 169.00, "selling_unit": "combo", "description": "1 Regular Shawarma Roll + 1 Blue Lagoon Mocktail.", "image_url": "https://images.unsplash.com/photo-1551024709-8f23befc6f87?auto=format&fit=crop&w=600&q=80", "available": True, "active": True, "inventory_product_id": "ING-SHAWARMA", "deduction_qty": 1.0},
            {"id": "SMC-04", "category_id": "cat-shawarma-mojitos", "name": "Roll + Mojito (Blue Lagoon) - Plate", "price": 209.00, "selling_unit": "combo", "description": "1 Shawarma Plate + 1 Blue Lagoon Mocktail.", "image_url": "https://images.unsplash.com/photo-1551024709-8f23befc6f87?auto=format&fit=crop&w=600&q=80", "available": True, "active": True, "inventory_product_id": "ING-SHAWARMA", "deduction_qty": 1.0},
            {"id": "SMC-05", "category_id": "cat-shawarma-mojitos", "name": "Roll + Mojito (Strawberry) - Roll", "price": 169.00, "selling_unit": "combo", "description": "1 Regular Shawarma Roll + 1 Strawberry Mojito.", "image_url": "https://images.unsplash.com/photo-1551024709-8f23befc6f87?auto=format&fit=crop&w=600&q=80", "available": True, "active": True, "inventory_product_id": "ING-SHAWARMA", "deduction_qty": 1.0},
            {"id": "SMC-06", "category_id": "cat-shawarma-mojitos", "name": "Roll + Mojito (Strawberry) - Plate", "price": 209.00, "selling_unit": "combo", "description": "1 Shawarma Plate + 1 Strawberry Mojito.", "image_url": "https://images.unsplash.com/photo-1551024709-8f23befc6f87?auto=format&fit=crop&w=600&q=80", "available": True, "active": True, "inventory_product_id": "ING-SHAWARMA", "deduction_qty": 1.0},
            {"id": "SMC-07", "category_id": "cat-shawarma-mojitos", "name": "Roll + Mojito (Green Apple) - Roll", "price": 169.00, "selling_unit": "combo", "description": "1 Regular Shawarma Roll + 1 Green Apple Mojito.", "image_url": "https://images.unsplash.com/photo-1551024709-8f23befc6f87?auto=format&fit=crop&w=600&q=80", "available": True, "active": True, "inventory_product_id": "ING-SHAWARMA", "deduction_qty": 1.0},
            {"id": "SMC-08", "category_id": "cat-shawarma-mojitos", "name": "Roll + Mojito (Green Apple) - Plate", "price": 209.00, "selling_unit": "combo", "description": "1 Shawarma Plate + 1 Green Apple Mojito.", "image_url": "https://images.unsplash.com/photo-1551024709-8f23befc6f87?auto=format&fit=crop&w=600&q=80", "available": True, "active": True, "inventory_product_id": "ING-SHAWARMA", "deduction_qty": 1.0},
            {"id": "SMC-09", "category_id": "cat-shawarma-mojitos", "name": "Roll + Mojito (Watermelon) - Roll", "price": 169.00, "selling_unit": "combo", "description": "1 Regular Shawarma Roll + 1 Watermelon Mojito.", "image_url": "https://images.unsplash.com/photo-1551024709-8f23befc6f87?auto=format&fit=crop&w=600&q=80", "available": True, "active": True, "inventory_product_id": "ING-SHAWARMA", "deduction_qty": 1.0},
            {"id": "SMC-10", "category_id": "cat-shawarma-mojitos", "name": "Roll + Mojito (Watermelon) - Plate", "price": 209.00, "selling_unit": "combo", "description": "1 Shawarma Plate + 1 Watermelon Mojito.", "image_url": "https://images.unsplash.com/photo-1551024709-8f23befc6f87?auto=format&fit=crop&w=600&q=80", "available": True, "active": True, "inventory_product_id": "ING-SHAWARMA", "deduction_qty": 1.0},

            # Mojitos
            {"id": "MOJ-01", "category_id": "cat-mojitos", "name": "Lemon Mint Mojito", "price": 79.00, "selling_unit": "glass", "description": "Zesty fresh lime with crushed mint leaves and sparkling soda.", "image_url": "https://images.unsplash.com/photo-1513558161293-cdaf765ed2fd?auto=format&fit=crop&w=600&q=80", "available": True, "active": True},
            {"id": "MOJ-02", "category_id": "cat-mojitos", "name": "Blue Lagoon Mojito", "price": 89.00, "selling_unit": "glass", "description": "Vibrant blue curaçao with lemon soda and crushed ice.", "image_url": "https://images.unsplash.com/photo-1513558161293-cdaf765ed2fd?auto=format&fit=crop&w=600&q=80", "available": True, "active": True},
            {"id": "MOJ-03", "category_id": "cat-mojitos", "name": "Green Apple Mojito", "price": 89.00, "selling_unit": "glass", "description": "Crisp green apple syrup with mint and fizzy soda.", "image_url": "https://images.unsplash.com/photo-1513558161293-cdaf765ed2fd?auto=format&fit=crop&w=600&q=80", "available": True, "active": True},
            {"id": "MOJ-04", "category_id": "cat-mojitos", "name": "Watermelon Mojito", "price": 89.00, "selling_unit": "glass", "description": "Sweet fresh watermelon flavor with lime and mint.", "image_url": "https://images.unsplash.com/photo-1513558161293-cdaf765ed2fd?auto=format&fit=crop&w=600&q=80", "available": True, "active": True},
            {"id": "MOJ-05", "category_id": "cat-mojitos", "name": "Strawberry Mojito", "price": 89.00, "selling_unit": "glass", "description": "Crushed strawberry infused with mint and sparkling soda.", "image_url": "https://images.unsplash.com/photo-1513558161293-cdaf765ed2fd?auto=format&fit=crop&w=600&q=80", "available": True, "active": True},
        ...
        # Record one-time flag so subsequent restarts NEVER overwrite user deletions
        db["system_flags"].update_one(
            {"key": "master_data_seeded"},
            {"$set": {"key": "master_data_seeded", "seeded_at": now}},
            upsert=True
        )
        print("--> Master data population into MongoDB completed and flag recorded.")
